...
for (let i =0; i < githubData.length; i++) {
  const payloadStuff = githubData[i]
  if (payloadStuff.payload.hasOwnProperty("commits")) {
    totalCommits += payloadStuff.payload.commits.length
  }
}
console.log(totalCommits)

// ********************This is how you do it using a forEach loop***************************
...
// or
// console.table(eventCount)        if you want to view it in browser
